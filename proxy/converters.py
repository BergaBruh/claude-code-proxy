...
from proxy.models import MessagesRequest, MessagesResponse, Usage
from proxy.providers.gemini_format import clean_gemini_schema
...
def convert_litellm_to_anthropic(litellm_response: Union[Dict[str, Any], Any],
    ...
    try:
        ...
        # Add tool calls if present - only for Claude models
